...
struct customer{
  ...
  int acount_num;
  int balance;
  int tax_payment;//The tax payment for the service
  float price;
  int seat_place[5][2];
...
void create()
{
    ...
    user[counter].price=dis*10+user[counter].tax_payment;
    dest_code(ends);
...
void admin()
{
    ...
    string password="0000";
     cout<<"Enter the username: "<<user;
     cout<<"Enter passcode: "<<pass;
     if((user==username)&&(password==pass))
        {
            cout<<"Welcome to bus manegment system "<<endl;
            cout<<"Cho#include<iostream>
#include<cmath>
